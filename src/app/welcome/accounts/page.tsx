  ...
  return (
    <div className="bg-black text-white min-h-screen flex flex-col">
      <main className="flex-grow flex flex-col items-center justify-center p-8">
        ...
        <p className="text-gray-400 mb-12"># Decide the slogan later</p>
        
        <div className="w-full max-w-md space-y-8">
          <div>
            <h2 className="text-2xl mb-10">Create an account</h2>
            <div className="relative">
              ...
              />
              <button className="mt-6 flex w-full justify-center rounded-[7px] bg-primary p-[13px] font-medium text-white hover:bg-opacity-90 dark:bg-gray-7">
                Create Account
              </button>
            </div>
          </div>
